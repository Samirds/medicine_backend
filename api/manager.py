...
#     def create_user(self, email, password, first_name, age, gender, **extra_fields):
#          if not email:
...
#          user = self.model(email=email, first_name=first_name, age=age, gender=gender, **extra_fields)
#          user.set_password(password)
#          user.save()
#          return user
    

#     def create_superuser(self, email, password, first_name, age, gender, **extra_fields):
